    ...
    <div class="container">
        <div class="header">
            ...
            <div class="nav-menu">
                ...
                <a href="https://research-discussion-record.vercel.app" target="_blank">📋 ディスカッション記録</a>
            </div>
            <span class="badge">ナビゲーション統合完了</span>
        ...
        <div class="section" id="results">
            ...
            <div class="result-box">
                <h4>実験2: カテゴリ数最適化</h4>
                <p><strong>最優秀結果:</strong></p>
                <ul>
                    <li><strong>16カテゴリ:</strong> 87.1% (+27.3%向上)</li>
                    <li><strong>統計的有意性:</strong> p &lt; 0.001</li>
                    <li><strong>Cohen's d:</strong> 1.2 (大きな効果サイズ)</li>
